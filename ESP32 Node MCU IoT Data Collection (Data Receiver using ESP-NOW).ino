//----------------------------------------------------------------
// ESP32 Automated Irrigation System with IoT Data Collection (Data Sender using ESP-NOW)
//
...
//
// this is a system utilizing a DOIT ESP32 Devkit V1, DHT22 temp & humidity sensor, SSD1306 0.96" OLED display, 4 LEDs, 4 capacitive soil moisture sensors, 
// and a 5V quad-relay module (for water pumps and solenoid valves), 
// operating an automated irrigation system by actuating the water pump and solenoid valves based off of each soil moisture sensor's readings
//
...
// TLF_PROTOTYPE_ESP32_IoT_SYSTEM
